...
(function(){
  'use strict';
  var VER = (window.GESIT_PWA_VERSION || '2026.08.11.07');
  function inject(){
...
@media (max-width:768px){
  ...
  body.gesit-tour-active #mobileBottomNav,body.gesit-tour-active #mobileMenuSheet,body.gesit-tour-active #mobileMenuBackdrop{display:none!important;pointer-events:none!important;} body.gesit-tour-active{overflow-y:auto!important;}
