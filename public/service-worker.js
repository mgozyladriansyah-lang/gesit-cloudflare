...
const GESIT_PWA_VERSION = '2026.08.11.07';
...
const CORE_ASSETS = [
  ...
  '/js/mobile-navigation.js?v=5', '/js/pwa-stability.js?v=' + GESIT_PWA_VERSION, '/css/styles-1-dasar.css?v=' + GESIT_PWA_VERSION, '/css/styles-2-komponen.css?v=' + GESIT_PWA_VERSION, '/css/styles-3-halaman.css?v=' + GESIT_PWA_VERSION, '/css/styles-4-lanjutan.css?v=' + GESIT_PWA_VERSION, '/css/styles-5-registrasi.css?v=' + GESIT_PWA_VERSION, '/css/pwa.css?v=' + GESIT_PWA_VERSION, '/js/notification-center.js?v=' + GESIT_PWA_VERSION, '/js/interaction-unlock.js?v=' + GESIT_PWA_VERSION, '/js/scripts-6-tour.js?v=' + GESIT_PWA_VERSION, '/css/pwa.css',
