...
const GESIT_PWA_VERSION = '2026.08.11.04';
...
const CORE_ASSETS = [
  ...
  '/js/mobile-navigation.js?v=5', '/js/pwa-stability.js?v=' + GESIT_PWA_VERSION, '/js/notification-center.js?v=' + GESIT_PWA_VERSION, '/js/interaction-unlock.js?v=' + GESIT_PWA_VERSION, '/css/pwa.css',
